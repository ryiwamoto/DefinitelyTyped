// Type definitions for EventEmitter v4.2.9
...
declare module eventemitter {
    /**
     * listener functions for events in object.
     */
    ...
    export class EventEmitter {
         ...
         */
        static noConflict(): typeof eventemitter.EventEmitter;
         ...
         * @return {Function[]|Object} All listener functions for the event.
         */
        getListeners(event: RegExp): ListenersInObject;
         ...
         * @return {ListenersInObject} All listener functions for an event in object
         */
         ...
         * @return {EventEmitter} Current instance of EventEmitter for chaining.
         */
        addListeners(event: Object): EventEmitter;
         ...
         * @return {EventEmitter} Current instance of EventEmitter for chaining.
         */
        removeListeners(event: Object): EventEmitter;
         ...
         * @return {EventEmitter} Current instance of EventEmitter for chaining.
         */
        manipulateListeners(remove: boolean, event: Object): EventEmitter;
