...
function testFlattenListeners(){
    var listeners: Function[] = emitter.flattenListeners([{listeners: listener}]);
}
...
function testDefineEvent(){
    var e: eventemitter.EventEmitter = emitter.defineEvent("foo", listener);
}

function testDefineEvents(){
    var e: eventemitter.EventEmitter = emitter.defineEvents(["foo", "bar"], listener);
}
